...
case class Period(id: Option[Long] = None, boardId: String, startDate: Date, endDate: Date, periodInDayes: Option[Int] = Some(0))
case class Point(id: Option[Long] = None, boardId: String, date: Date, scope: Int, progress: Int, finished: Int)
